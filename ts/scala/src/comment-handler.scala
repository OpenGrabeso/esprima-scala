...
class CommentHandler() {
  ...
  def insertInnerComments(node: Any, metadata: SourceLocation) = {
  ...
  def visitNode(node: Any, metadata: NodeInfo) = {
  ...
  def visitComment(node: Comment, metadata: SourceLocation) = {
  ...
  def visit(node: Comment, metadata: SourceLocation) = {
